...
This is a solo-developer, best-effort project provided **as-is**. There is **no
guaranteed response time and no commitment to fixes** — but security reports are
still appreciated and will be looked at when time allows.
